...
<section class="products">
    <div class="container">
        ...
        <hr class="hr" />
        <div class="row">
            <div class="col span_1_of_4 span_1_of_2 col-sm" v-for="product in products" :key="product.id">
                ...
                <div class="product">
                    ...
                    <div class="product__info">
                        <div class="product__rating" v-for="(review, index) in stars" :key="index">
                            <i v-for="(star, index) in review.star" :key="index" class="product__star fa fa-star checked"></i>
                        ...
                        <div class="product__cart">
                            ...
                            <button class="product__button">
                                <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.72723 10.1818H23.2727L25.4545 28H6.54541L8.72723 10.1818Z" stroke="white"></path>
                                    <path d="M20.3636 10.1818C20.3636 10.1818 20.3636 8.51 20.3636 7.99999C20.3636 5.59002 18.41 3.63635 16 3.63635C13.59 3.63635 11.6364 5.59002 11.6364 7.99999C11.6364 8.51 11.6364 10.1818 11.6364 10.1818" stroke="white"></path>
